...
SI_SEGMENT_VARIABLE(PROTOCOL_PULSES(DG_HOSA)[], static uint16_t, SI_SEG_CODE) = { 590, 1500, 13450 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(DG_HOSA)[], static uint8_t, SI_SEG_CODE) = { 0, 2 };
